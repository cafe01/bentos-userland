/// `chat-codec event` — construct ChatEvent frames and emit as JSONL.
///
...
class EventCommand extends Command<int> {
  ...
  @override
  String get invocation => 'chat-codec event <token> [<token>…]';
  ...
  Future<int> run() async {
    ...
    for (final token in tokens) {
      ...
      try {
        ...
        stderr.writeln('chat-codec event: malformed token "$token" — $e');
        return 64;
      }
