...
///
/// A pure parser: [load] takes the metadata [File] itself — where it lives is
/// the place primitive's law, never constructed here.
final class PlaceMeta {
  ...
  /// Parse metadata from [file]. Hermetic via `IOOverrides`, as all of
  /// `dart:io`.
  static PlaceMeta load(File file) {
