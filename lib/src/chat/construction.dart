...
/// Builds a channel at [name], over the bodies that write and the tree that
/// reads, acting under [identity].
///
...
/// theirs, the bound is the caller's.
...
/// What this library builds: a [LocalChannel] over the two seams.
