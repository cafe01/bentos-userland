/// `chat-data fold` — reduce a ChatEvent JSONL stream into a ChatMessage.
///
...
class FoldCommand extends Command<int> {
  ...
  String get description =>
      ...
      'Usage: llm … | chat-data fold >> messages.jsonl';

  @override
  String get invocation => 'llm … | chat-data fold';
  ...
  Future<int> run() async {
    ...
    // Feed stdin lines into the controller as ChatEvents, then close.
    final feedFuture = stdin
      ...
      try {
        ...
        controller.addError(
          FormatException('chat-data fold: malformed event line — $e'),
        );
      }
    ...
    try {
      ...
      stderr.writeln('chat-data fold: $e');
      return 1;
    }
    return 0;
  }
